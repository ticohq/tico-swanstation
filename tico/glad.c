/*
    ...
    Commandline:
        --profile="core" --api="gl=4.3" --generator="c" --spec="gl" --no-loader
   --local-files --omit-khrplatform --extensions="" Online:
...
static int get_exts(void) {
  ...
  if (max_loaded_major < 3) {
    ...
    if (num_exts_i > 0) {
      exts_i = (char **)realloc((void *)exts_i,
                                (size_t)num_exts_i * (sizeof *exts_i));
    }
